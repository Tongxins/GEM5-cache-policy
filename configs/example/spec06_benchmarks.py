...
binary_dir = '/home/server2/stx-gem/spec06/spec06-x86/benchspec/CPU2006/'  
data_dir = '/home/server2/stx-gem/spec06/spec06-x86/benchspec/CPU2006/'  
  
#====================  
#400.perlbench  
perlbench = LiveProcess()  
perlbench.executable =  binary_dir+'400.perlbench/exe/perlbench_base.amd64-m64-gcc42-nn'  
data=data_dir+'400.perlbench/data/train/input/suns.pl'  
perlbench.cmd = [perlbench.executable] + [data]  
perlbench.output = 'attrs.out'  
  
#401.bzip2  
bzip2 = LiveProcess()  
bzip2.executable =  binary_dir+'401.bzip2/exe/bzip2_base.amd64-m64-gcc42-nn'  
...
#403.gcc  
gcc = LiveProcess()  
gcc.executable =  binary_dir+'403.gcc/exe/gcc_base.amd64-m64-gcc42-nn'  
...
#410.bwaves  
bwaves = LiveProcess()  
bwaves.executable =  binary_dir+'410.bwaves/exe/bwaves_base.amd64-m64-gcc42-nn'  
...
#416.gamess  
gamess=LiveProcess()  
gamess.executable =  binary_dir+'416.gamess/exe/gamess_base.amd64-m64-gcc42-nn' 
data=data_dir+'416.gamess/data/test/input/h2ocu2+.energy.inp' 
gamess.cmd = [gamess.executable] + [data]
gamess.input=data_dir+'416.gamess/data/test/input/h2ocu2+.energy.config'  
gamess.output=data_dir+'416.gamess/data/test/output/h2ocu2+.energy.output'  
  
#429.mcf  
mcf = LiveProcess()  
mcf.executable =  binary_dir+'429.mcf/exe/mcf_base.amd64-m64-gcc42-nn'  
...
#433.milc  
milc=LiveProcess()  
milc.executable = binary_dir+'433.milc/exe/milc_base.amd64-m64-gcc42-nn'  
...
#434.zeusmp  
zeusmp=LiveProcess()  
zeusmp.executable =  binary_dir+'434.zeusmp/exe/zeusmp_base.amd64-m64-gcc42-nn'  
...
#435.gromacs  
gromacs = LiveProcess()  
gromacs.executable =  binary_dir+'435.gromacs/exe/gromacs_base.amd64-m64-gcc42-nn'  
...
cactusADM.executable =  binary_dir+'436.cactusADM/exe/cactusADM_base.amd64-m64-gcc42-nn'  
...
leslie3d.executable =  binary_dir+'437.leslie3d/exe/leslie3d_base.amd64-m64-gcc42-nn'  
...
#444.namd  
namd = LiveProcess()  
namd.executable =  binary_dir+'444.namd/exe/namd_base.amd64-m64-gcc42-nn'  
...
#445.gobmk  
gobmk=LiveProcess()  
gobmk.executable =  binary_dir+'445.gobmk/exe/gobmk_base.amd64-m64-gcc42-nn'  
...
#447.dealII  
dealII=LiveProcess()  
dealII.executable =  binary_dir+'447.dealII/exe/dealII_base.amd64-m64-gcc42-nn'  
dealII.cmd = [dealII.executable]+['36']  
dealII.output='log'  
  
#450.soplex  
soplex=LiveProcess()  
soplex.executable =  binary_dir+'450.soplex/exe/soplex_base.amd64-m64-gcc42-nn'  
data=data_dir+'450.soplex/data/test/input/test.mps'  
soplex.cmd = [soplex.executable]+[data]  
soplex.output = 'test.out'  
  
#453.povray  
povray=LiveProcess()  
povray.executable =  binary_dir+'453.povray/exe/povray_base.amd64-m64-gcc42-nn'  
...
calculix.executable =  binary_dir+'454.calculix/exe/calculix_base.amd64-m64-gcc42-nn'  
...
#456.hmmer  
hmmer=LiveProcess()  
hmmer.executable =  binary_dir+'456.hmmer/exe/hmmer_base.amd64-m64-gcc42-nn'  
...
#458.sjeng  
sjeng=LiveProcess()  
sjeng.executable =  binary_dir+'458.sjeng/exe/sjeng_base.amd64-m64-gcc42-nn'  
...
GemsFDTD.executable =  binary_dir+'459.GemsFDTD/exe/GemsFDTD_base.amd64-m64-gcc42-nn'  
GemsFDTD.cmd = [GemsFDTD.executable]  
GemsFDTD.output = 'test.log'  
  
#462.libquantum  
libquantum=LiveProcess()  
libquantum.executable =  binary_dir+'462.libquantum/exe/libquantum_base.amd64-m64-gcc42-nn'  
libquantum.cmd = [libquantum.executable],'1297','8'  
libquantum.output = 'test.out'  
  
#464.h264ref  
h264ref=LiveProcess()  
h264ref.executable =  binary_dir+'464.h264ref/exe/h264ref_base.amd64-m64-gcc42-nn'  
...
#465.tonto
tonto=LiveProcess()
tonto.executable = binary_dir+'465.tonto/exe/tonto_base.amd64-m64-gcc42-nn'
data=data_dir+'465.tonto/data/test/input/stdin'
tonto.cmd = [tonto.executable]
tonto.output = 'stdout'
  
#470.lbm  
lbm=LiveProcess()  
lbm.executable =  binary_dir+'470.lbm/exe/lbm_base.amd64-m64-gcc42-nn'  
...
#471.omnetpp  
omnetpp=LiveProcess()  
omnetpp.executable =  binary_dir+'471.omnetpp/exe/omnetpp_base.amd64-m64-gcc42-nn'  
...
#473.astar  
astar=LiveProcess()  
astar.executable =  binary_dir+'473.astar/exe/astar_base.amd64-m64-gcc42-nn'  
...
#481.wrf  
wrf=LiveProcess()  
wrf.executable =  binary_dir+'481.wrf/exe/wrf_base.amd64-m64-gcc42-nn'  
...
#482.sphinx  
sphinx3=LiveProcess()  
sphinx3.executable =  binary_dir+'482.sphinx3/exe/sphinx_livepretend_base.amd64-m64-gcc42-nn'  
sphinx3.cmd = [sphinx3.executable]+['ctlfile', '.', 'args.an4']  
sphinx3.output = 'an4.out'  
  
#483.xalancbmk  
xalancbmk=LiveProcess()  
xalancbmk.executable =  binary_dir+'483.xalancbmk/exe/Xalan_base.amd64-m64-gcc42-nn'  
xalancbmk.cmd = [xalancbmk.executable]+['-v','test.xml','xalanc.xsl']  
xalancbmk.output = 'test.out'  
  
#998.specrand  
specrand_i=LiveProcess()  
specrand_i.executable = binary_dir+'998.specrand/exe/specrand_base.amd64-m64-gcc42-nn'  
specrand_i.cmd = [specrand_i.executable] + ['1255432124','234923'] 
specrand_i.output = 'rand.24239.out'  
  
#999.specrand  
specrand_f=LiveProcess()  
specrand_f.executable = binary_dir+'999.specrand/exe/specrand_base.amd64-m64-gcc42-nn'  
